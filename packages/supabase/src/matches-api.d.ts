...
declare const _default: (client: SupabaseClient<Database>) => {
    createMatch: (values: MatchesInsert) => PromiseLike<import("@supabase/supabase-js").PostgrestSingleResponse<{
        id: number;
    ...
    getMatch: (matchId: number | undefined) => PromiseLike<import("@supabase/supabase-js").PostgrestSingleResponse<MatchesJoined>>;
    updateMatch: (matchId: number | undefined, values: MatchesUpdate) => import("@supabase/postgrest-js").PostgrestFilterBuilder<{
        Tables: {
            discord_channels: {
                Row: {
                    id: number;
    ...
    updateMatchPlayer: (matchId: number, playerId: string, values: Partial<MatchPlayersRow>) => import("@supabase/postgrest-js").PostgrestFilterBuilder<{
        Tables: {
            discord_channels: {
                Row: {
                    id: number;
    ...
    createMatchMaps: (match_id: number, ...maps: Array<number>) => import("@supabase/postgrest-js").PostgrestFilterBuilder<{
        Tables: {
            discord_channels: {
                Row: {
                    id: number;
