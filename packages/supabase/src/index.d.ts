...
export declare const client: () => {
    getPlayerByUserId: (userId: string) => PromiseLike<PostgrestSingleResponse<{
        id: string;
        updated_at: string;
        username: string;
        full_name: string;
    ...
    getMatch: (matchId: number | undefined) => PromiseLike<PostgrestSingleResponse<import("./types").MatchesJoined>>;
...
export declare const remixClient: (request: Request) => {
    response: Response;
    getSession: () => Promise<{
        data: {
...
export declare const verifyResult: <T>({ data, error }: PostgrestResponse<T>) => T[];
export declare const verifySingleResult: <T>({ data, error }: PostgrestSingleResponse<T>) => T;
