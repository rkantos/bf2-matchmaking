...
const MATCH_CHANNEL_NAME = /^Match \d+ (Team [12]|Finished T1: \d+ T2: \d+)$/;
 ...
 *
 * Abbreviated rather than spelled out so every match id fits: TeamSpeak rejects
 * a channel name over 40 characters, and "Match 4819 Finished Team1: 220 Team2:
 * 110" is 41.
 */
export function resultsChannelName(
  ...
  return `Match ${matchId} Finished T1: ${team1Tickets} T2: ${team2Tickets}`;
}
